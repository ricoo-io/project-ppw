                            ...
                            <div class="form-container">
                                <form ction="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="kategori" name="kategori" required value="<?php echo $item['f_kategori'] ?>" class="form-input">
                                    </div>
...
if (isset($_POST['simpan'])) {
    ...
    $sql = "UPDATE t_kategori SET f_kategori='$kat', f_gambar='$gam' WHERE f_id='$id'";
    $db->runSQL($sql);
