...
$search_keyword = "(t_barang.f_pakaian LIKE '%$search%' OR t_kategori.f_kategori LIKE '%$search%')";
if (!empty($categoryId)) {
    $search_keyword .= " AND t_barang.f_idkategori = $categoryId";
}
    ...
    <div class="container-2">
        ...
        <div class="content-2">
            ...
            class="<?php echo (!isset($_GET['id']) || $_GET['id'] == 0) ? 'active' : ''; ?>"><h3 class="category-heading">Categories</h3></a>
                 <ul>
                    <li>
                        <a href="search.php?search=<?php echo urlencode($search); ?>" 
                        class="<?php echo empty($categoryId) ? 'active' : ''; ?>">All</a>
                    </li>
                    <?php foreach ($categories as $category): ?>
                        <li>
                            <a href="search.php?category=<?php echo urlencode($category['f_id']); ?>&search=<?php echo urlencode($search); ?>" 
                            class="<?php echo $categoryId == $category['f_id'] ? 'active' : ''; ?>">
                ...
                <div class="page-detail">
                    ...
                    <form method="GET" action="" class="sort-form">
                        ...
                        <select name="sort" onchange="this.form.submit()" class="sort-select">
                            ...
                            <option value="size_asc" <?php echo (isset($_GET['sort']) && $_GET['sort'] == 'size_asc') ? 'selected' : ''; ?>>Size (S-XL)</option>
                            <option value="size_desc" <?php echo (isset($_GET['sort']) && $_GET['sort'] == 'size_desc') ? 'selected' : ''; ?>>Size (XL-S)</option>
